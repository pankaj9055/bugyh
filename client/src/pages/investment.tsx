          ...
          {plansLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 md:gap-4">
              {plans?.map((plan: any) => {
                ...
                const userHasInvested = userInvestments?.some((inv: any) => 
                  inv.planId === plan.id && (inv.status === "active" || inv.status === "completed")
                );
                  ...
                  <Card 
                    ...
                    className={`transition-all cursor-pointer ${
                      userHasInvested 
                        ...
                        : "border-gold-200 hover:border-gold-300 hover:shadow-md"
                    }`}
                  >
                    ...
                    <CardContent className="pt-0">
                      <div className="text-center space-y-3">
                        <div className={`text-3xl font-bold ${userHasInvested ? 'text-gray-500' : 'text-gold-600'}`}>
                        ...
                        <div className="pt-2">
                          ...
                          {!userHasInvested && parseFloat(user?.balance || "0") < parseFloat(plan.amount) && (
          ...
          <Card className="border-blue-200">
            <CardContent className="p-6">
              ...
              <ul className="text-sm text-gray-600 space-y-2">
                <li>• Choose an investment plan (one-time only)</li>
                <li>• Receive daily returns for 20 days</li>
                <li>• Withdraw only daily returns (original amount is retained)</li>
                <li>• No cancellation option once invested</li>
              </ul>
            </CardContent>
          </Card>
