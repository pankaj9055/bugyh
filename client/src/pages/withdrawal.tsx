...
export default function Withdrawal() {
  ...
  const hasPaymentMethods = (profile as any)?.upiId || ((profile as any)?.accountNumber && (profile as any)?.ifscCode);
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} defaultValue={field.value}>
                          ...
                          <SelectContent>
                            {(profile as any)?.upiId && (
                              <SelectItem value="upi">
                                <div className="flex items-center">
                                  <Smartphone className="mr-2" size={16} />
                                  UPI - {(profile as any).upiId}
                                </div>
                              </SelectItem>
                            )}
                            {(profile as any)?.accountNumber && (profile as any)?.ifscCode && (
                              <SelectItem value="bank">
                                <div className="flex items-center">
                                  <Building2 className="mr-2" size={16} />
                                  Bank - ***{(profile as any).accountNumber?.slice(-4)}
                                </div>
                              </SelectItem>
                            )}
                          </SelectContent>
