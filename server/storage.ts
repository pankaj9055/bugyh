  ...
  async processDailyReturns(): Promise<void> {
    ...
    for (const investment of activeInvestments) {
      ...
      if (!existingReturn) {
        ...
        // Update user balance (only daily returns, not original amount)
        await this.updateUserBalance(investment.userId, investment.dailyReturn);
